...
\marginpar{\rule[-15mm]{0.4mm}{15mm}}{
\textbf{注意：}为什么会在这里？这个公式看来很神奇！嗯，它基本上是一个使用等比级数的加权平均值。我不知道这是否有名字（我甚至查过维基百科！），但是如果想要 更多的信息，\href{http://www.dranger.com/ffmpeg/weightedmean.html}{这里是一个解释}（或者\href{http://www.dranger.com/ffmpeg/weightedmean.txt}{weightedmean.txt} ）。}
